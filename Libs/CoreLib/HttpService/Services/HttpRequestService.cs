...
/// <summary>
/// Высокоуровневый сервис: собирает запрос, отправляет и десериализует ответ
/// </summary>
internal sealed class HttpRequestService : IHttpRequestService
{
        ...
        HttpConnectionData connectionData = default)
    {
        ...
        // тело
        if (HttpMethodAllowsBody(requestData.Method) && requestData.Body is not null)
        {
